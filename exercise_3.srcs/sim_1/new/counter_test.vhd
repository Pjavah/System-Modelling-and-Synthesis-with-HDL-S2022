...
architecture Behavioral of counter_test is
    ...
    -- for debugging purposes, only one 8bit counter is used.
    signal test_count : std_logic_vector(7 downto 0) := "00000000";
    -- signal test_count2 : std_logic_vector(7 downto 0) := "00000000";
    signal test_over : std_logic := '0';

begin
    DUT: counter port map (clk => test_clk, enable => test_enable, reset => test_reset, load => test_load, down_up => test_down_up, data => test_data, count => test_count, over => test_over);--, count2 => test_count2
    process
-- test clock:
        begin
            test_clk <=  '0';
